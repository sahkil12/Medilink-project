...
const Hero = () => {
    ...
    return (
            <section className="">
	<div className={`container mx-auto flex flex-col items-center px-4 py-8 text-center border-2 border-gray-300 my-3 rounded-xl `}>
		<div className="md:w-[85%] mx-auto space-y-8 sm:space-y-6 p-3">
		...
		<div className="flex flex-row gap-2 md:w-[75%] mx-auto my-6">
			<input type="text" placeholder="Search any doctor..." className="w-3/5 p-3 sm:w-2/3 border border-gray-400 rounded-full px-5" />
			<button type="button" className="w-2/5 p-2 rounded-full sm:w-1/4 bg-green-400 font-bold text-lg">Search Now</button>
		</div>
        {/* image */}
